...
<div class="logo_products">
	<div class="container">
		...
		<div class="col-md-10">
			<!--atas-->
			<h1 style="text-align: center;">#hashtagA</h1>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="images/kylie3.jpg"></a>		
											<p>Gambar 1</p>
										</div>
										<div class="snipcart-details top_brand_home_details">
											<form action="#" method="post">
												<fieldset>
												<a href="{{url('')}}/single">
													<input type="button" name="submit" value="Read Me" class="button">
												</a>
												</fieldset>
											</form>
										</div>
		...
		<!--bagian kedua-->
			<h1 style="text-align: center;">#hashtagB</h1>
			<div class="col-md-12" style="margin:10px">
				<div class="col-md-4 top_brand_left" >
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
